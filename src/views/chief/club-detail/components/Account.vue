<template>
  <el-form label-width="200px">
    <el-form-item label="社团名称">
      <el-input v-model.trim="clubinfo.name" :readonly="true" />
    </el-form-item>
    <el-form-item label="社长名字">
      <el-input v-model.trim="clubinfo.chiefName" :readonly="true" />
    </el-form-item>
    <el-form-item label="成员数">
      <el-input v-model.trim="clubinfo.memberCount" :readonly="true" />
    </el-form-item>
    <el-form-item label="社团类型">
      <el-select v-model.trim="clubinfo.type" style="width:500px;" placeholder="请选择社团类别">
